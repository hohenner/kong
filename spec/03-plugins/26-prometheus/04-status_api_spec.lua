...
describe("Plugin: prometheus (access via status API)", function()
  ...
  it("increments the count for proxied requests", function()
    ...
    assert.matches('kong_kong_latency_ms_bucket{service="mock-service",route="http-route",le="+Inf"} 2', body, nil, true)
    assert.matches('kong_upstream_latency_ms_bucket{service="mock-service",route="http-route",le="+Inf"} 2', body, nil, true)
    assert.matches('kong_session_latency_ms_bucket{service="mock-service",route="http-route",le="+Inf"} 2', body, nil, true)
